...
-- -----------------------------------------------------
-- Table `libraryitego`.`avalicao`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `libraryitego`.`avalicao` (
...
CREATE TABLE IF NOT EXISTS `libraryitego`.`emprestimo` (
  ...
  `data_emrpestimo` DATETIME NOT NULL,
  ...
  PRIMARY KEY (`idemprestimo`, `usuario_idusuario`, `livro_idlivro`),
  ...
  CONSTRAINT `fk_emprestimo_avalicao1`
    ...
    REFERENCES `libraryitego`.`avalicao` (`idavalicao`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `libraryitego`.`patrimonio` (
  ...
  INDEX `fk_patrimonio_livro1_idx` (`livro_idlivro` ASC),
